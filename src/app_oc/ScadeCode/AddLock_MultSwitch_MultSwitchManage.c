...
/* MultSwitchManage::AddLock_MultSwitch/ */
void AddLock_MultSwitch_MultSwitchManage(
  ...
  _6_array *outMultSWitchData_SA)
{
  ...
  if (inwNumOfMultSwitch > kcg_lit_uint16(0)) {
    /* _L1= */
    for (idx = 0; idx < 2; idx++) {
      /* _L1=(MultSwitchManage::AddLock_MultSwitch_C1#1)/ */
      AddLock_MultSwitch_C1_MultSwitchManage(
        /* _L1= */(kcg_uint16) idx,
        inCommandNumOfMultSwitch,
        inCmdData_SA,
...
/* $********** SCADE Suite KCG 32-bit 6.6 (build i19) ***********
** AddLock_MultSwitch_MultSwitchManage.c
** Generation date: 2020-01-13T16:36:03
*************************************************************$ */
