...
*************************************************************$ */
#ifndef _VOBCorTMCLockCmdValidityManage_each_Lock_SwitchCommandInvalidManage_H_
#define _VOBCorTMCLockCmdValidityManage_each_Lock_SwitchCommandInvalidManage_H_
...
extern void VOBCorTMCLockCmdValidityManage_each_Lock_SwitchCommandInvalidManage(
  /* index/ */
  kcg_uint16 index,
  /* _L15/, inOldNumOfCmd/ */
...
#endif /* _VOBCorTMCLockCmdValidityManage_each_Lock_SwitchCommandInvalidManage_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6 (build i19) ***********
** VOBCorTMCLockCmdValidityManage_each_Lock_SwitchCommandInvalidManage.h
** Generation date: 2020-01-13T16:36:03
*************************************************************$ */
